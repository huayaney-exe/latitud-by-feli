  ...
  return (
    <section className="py-20 bg-slate-900/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Platinum Partners */}
        <div className="mb-12">
          <h3 className="text-center text-orange-400 font-semibold mb-6 text-lg">
            🏆 SOCIOS PLATINUM
          </h3>
        ...
        {/* Media Partners */}
        <div className="mb-12">
          <h3 className="text-center text-amber-400 font-semibold mb-6">
            📰 MEDIA PARTNERS
          </h3>
        ...
        <div className="text-center mt-16">
          <div className="inline-block bg-gradient-to-r from-orange-900/30 to-amber-900/30 backdrop-blur-sm border border-orange-500/30 rounded-2xl p-8 max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="px-8 py-3 bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white font-semibold rounded-lg shadow-lg shadow-orange-500/20 transition"
              >
        ...
        <div className="mt-20 pt-12 border-t border-white/10">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="#pricing" className="hover:text-orange-400 transition">Tickets</a></li>
                <li><a href="#agenda" className="hover:text-orange-400 transition">Agenda</a></li>
                <li><a href="#" className="hover:text-orange-400 transition">Speakers</a></li>
                <li><a href="#" className="hover:text-orange-400 transition">Sponsors</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li className="flex items-center gap-2">
                  <span>📧</span>
                  <a href="mailto:hola@lataisummit.com" className="hover:text-orange-400 transition">
          ...
          <div className="text-center pt-8 border-t border-white/10">
            <p className="text-gray-500 text-sm">
              ...
              <a href="#" className="hover:text-orange-400 transition">Términos y Condiciones</a> |{' '}
